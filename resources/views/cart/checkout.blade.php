            ...
            <div class="row">
                <div class="col-lg-8">
                            ...
                            <form action="{{url('admin/formvalidate')}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="lastname" type="text" name="state" placeholder="Province" value="{{ old('state') }}" class="form-control">
                                        <br>
                                        <span style="color:red">{{ $errors->first('state') }}</span>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="lastname" class="form-label">Mobile Number</label>
                                        <input id="lastname" type="text" name="pincode" placeholder="Mobile Number" value="{{ old('pincode') }}" class="form-control">
                                        <br>
                                        <span style="color:red">{{ $errors->first('pincode') }}</span>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="lastname" class="form-label">Place</label>
                                        <input id="lastname" type="text" name="city" placeholder="Place" value="{{ old('city') }}" class="form-control">
                                        <br>
                    ...
                    <input type="radio" name="payment_type" value="esewa" checked="checked" > E-Sewa
                                    ...
                                    <input type="radio" name="payment_type" value="khalti"> Khalti
